...
for the server extension and a NPM package named `jupyter-viz-extension`
...
```bash
pip uninstall jupyter_viz_extension
```
...
# Change directory to the jupyter_viz_extension directory
...
jupyter server extension disable jupyter_viz_extension
pip uninstall jupyter_viz_extension
```
